/**
 * The requests screen: what it lists, and the two answers a pending row can
 * get. Approve opens the shared modal prefilled with what was asked for;
 * Dismiss is a DELETE that leaves the row behind as history.
 */
