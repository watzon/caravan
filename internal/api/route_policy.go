...
var routePolicies = []routePolicy{
	...
	{"system.status", "GET", "/system/status", routeAdmin, false}, {"system.backup", "GET", "/system/backup", routeAdmin, false}, {"system.restore", "POST", "/system/restore", routeAdmin, false}, {"system.shutdown", "POST", "/system/shutdown", routeAdmin, false}, {"system.verify", "POST", "/system/verify", routeAdmin, false}, {"system.directories", "GET", "/system/directories", routeAdmin, false}, {"storage.repoint", "POST", "/system/storage-root/repoint", routeAdmin, false}, {"storage.migrate", "POST", "/system/storage-root/migrate", routeAdmin, false}, {"storage.migration", "GET", "/system/storage-root/migration", routeAdmin, false},
	...
	{"stashbox-instances.list", "GET", "/adult/stashbox-instances", routeAdult, false}, {"stashbox-instances.create", "POST", "/adult/stashbox-instances", routeAdult, false}, {"stashbox-instances.test-config", "POST", "/adult/stashbox-instances/test", routeAdult, false}, {"stashbox-instances.update", "PUT", "/adult/stashbox-instances/{id}", routeAdult, false}, {"stashbox-instances.delete", "DELETE", "/adult/stashbox-instances/{id}", routeAdult, false}, {"stashbox-instances.test", "POST", "/adult/stashbox-instances/{id}/test", routeAdult, false},
