...
var routePolicies = []routePolicy{
	{"health", "GET", "/health", routeExempt, false},
	{"settings.get", "GET", "/settings", routeAdmin, false}, {"settings.put", "PUT", "/settings", routeAdmin, false}, {"settings.apikey", "POST", "/settings/apikey", routeAdmin, false}, {"settings.metadata-test", "POST", "/settings/metadata/test", routeAdmin, false}, {"settings.flaresolverr-test", "POST", "/settings/flaresolverr/test", routeAdmin, false},
	{"system.status", "GET", "/system/status", routeAdmin, false}, {"system.backup", "GET", "/system/backup", routeAdmin, false}, {"system.restore", "POST", "/system/restore", routeAdmin, false}, {"definition-packs.list", "GET", "/definition-packs", routeAdmin, false}, {"definition-packs.preview", "POST", "/definition-packs/preview", routeAdmin, false}, {"definition-packs.install", "POST", "/definition-packs/install", routeAdmin, false}, {"definition-packs.activate", "POST", "/definition-packs/activate", routeAdmin, false}, {"definition-packs.rollback", "POST", "/definition-packs/rollback", routeAdmin, false}, {"system.shutdown", "POST", "/system/shutdown", routeAdmin, false}, {"system.verify", "POST", "/system/verify", routeAdmin, false}, {"system.directories", "GET", "/system/directories", routeAdmin, false}, {"storage.repoint", "POST", "/system/storage-root/repoint", routeAdmin, false}, {"storage.migrate", "POST", "/system/storage-root/migrate", routeAdmin, false}, {"storage.migration", "GET", "/system/storage-root/migration", routeAdmin, false},
	{"setup.admin", "POST", "/setup/admin", routeExempt, true},
	...
	{"quality.list", "GET", "/quality-profiles", routeAdmin, false}, {"quality.create", "POST", "/quality-profiles", routeAdmin, false}, {"quality.update", "PUT", "/quality-profiles/{id}", routeAdmin, false}, {"quality.default", "PUT", "/quality-profiles/{id}/default", routeAdmin, false}, {"quality.delete", "DELETE", "/quality-profiles/{id}", routeAdmin, false}, {"wanted.list", "GET", "/wanted", routeAdmin, false}, {"wanted.search", "POST", "/wanted/search", routeAdmin, false},
	{"quality.test", "POST", "/quality-profiles/{id}/test", routeAdmin, false},
	{"quality.export", "GET", "/quality-profiles/export", routeAdmin, false}, {"quality.import", "POST", "/quality-profiles/import", routeAdmin, false},
	{"notifications.list", "GET", "/notification-webhooks", routeAdmin, false}, {"notifications.create", "POST", "/notification-webhooks", routeAdmin, false}, {"notifications.update", "PUT", "/notification-webhooks/{id}", routeAdmin, false}, {"notifications.delete", "DELETE", "/notification-webhooks/{id}", routeAdmin, false}, {"notifications.test", "POST", "/notification-webhooks/{id}/test", routeAdmin, false},
	...
	{"remote-paths.list", "GET", "/remote-path-mappings", routeAdmin, false}, {"remote-paths.create", "POST", "/remote-path-mappings", routeAdmin, false}, {"remote-paths.update", "PUT", "/remote-path-mappings/{id}", routeAdmin, false}, {"remote-paths.delete", "DELETE", "/remote-path-mappings/{id}", routeAdmin, false},
	{"images", "GET", "/images/{path...}", routeExempt, false}, {"import.list", "GET", "/import/queue", routeAdmin, false}, {"import.match", "POST", "/import/queue/{id}/match", routeAdmin, false}, {"import.delete", "DELETE", "/import/queue/{id}", routeAdmin, false}, {"events.list", "GET", "/events", routeAdmin, false}, {"events.stream", "GET", "/events/stream", routeAdmin, false},
