...
var routePolicies = []routePolicy{
	...
	{"system.status", "GET", "/system/status", routeAdmin, false}, {"system.backup", "GET", "/system/backup", routeAdmin, false}, {"system.restore", "POST", "/system/restore", routeAdmin, false}, {"system.shutdown", "POST", "/system/shutdown", routeAdmin, false}, {"system.verify", "POST", "/system/verify", routeAdmin, false}, {"storage.repoint", "POST", "/system/storage-root/repoint", routeAdmin, false}, {"storage.migrate", "POST", "/system/storage-root/migrate", routeAdmin, false}, {"storage.migration", "GET", "/system/storage-root/migration", routeAdmin, false},
